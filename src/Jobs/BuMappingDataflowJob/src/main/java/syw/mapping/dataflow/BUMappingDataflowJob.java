...
public class BUMappingDataflowJob {
	...
	public static class SplitLineDataTask extends DoFn<TableRow, Entity> {
		...
		public Entity makeEntity(TableRow content) {
			String SOAR_NO = (String) content.get("SOAR_NO");
			SOAR_NO = (SOAR_NO == null)?"":SOAR_NO;
			...
			String BUS_NBR = (String) content.get("BUS_NBR");
			BUS_NBR = (BUS_NBR == null)?"":BUS_NBR;
			
			String UNIT_NBR = (String) content.get("UNIT_NBR");
			UNIT_NBR = (UNIT_NBR == null)?"":UNIT_NBR;

			String DVSN_NBR = (String) content.get("DVSN_NBR");
			DVSN_NBR = (DVSN_NBR == null)?"":DVSN_NBR;

			String DEPT_NBR = (String) content.get("DEPT_NBR");
			DEPT_NBR = (DEPT_NBR == null)?"":DEPT_NBR;
			
			String CATG_CLUSTER_NBR = (String) content.get("CATG_CLUSTER_NBR");
			CATG_CLUSTER_NBR = (CATG_CLUSTER_NBR == null)?"":CATG_CLUSTER_NBR;
			
			String CATG_NBR = (String) content.get("CATG_NBR");
			CATG_NBR = (CATG_NBR == null)?"":CATG_NBR;
			
			String SUB_CATG_NBR = (String) content.get("SUB_CATG_NBR");
			SUB_CATG_NBR = (SUB_CATG_NBR == null)?"":SUB_CATG_NBR;
